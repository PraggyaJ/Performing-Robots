...
//}
  ...
  if (packetbuffer[1] == 'B') {
    ...
    while (buttnum == 5 && pressed == true && posServo1 < 150) {
      posServo1+=10;
    ...
    while(buttnum == 7 && pressed == true && posServo2 < 120){
      posServo2+= 10;
      Serial.print("pos servo2 = ");
      Serial.println(posServo2);
      myservo3.write(posServo2);
      myservo4.write(posServo2);
      delay(50);
    }

     while (buttnum == 8 && pressed == true && posServo2 >= 0) {
      posServo2-=10;
      Serial.print("pos servo2 = ");
      Serial.println(posServo2);
      myservo3.write(posServo2);
